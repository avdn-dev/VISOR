...
struct GenerateSpyMacroTests {
  ...
  func `Generates spy with optional and fatalError for unknown return type`() {
    assertMacroExpansionSwiftTesting(
      ...
      diagnostics: [
        DiagnosticSpec(
          message: #"@GenerateSpy: Custom types without known defaults use implicitly unwrapped optionals for properties and fatalError for methods. Use @DefaultValue for properties or @DefaultReturn for method returns."#,
          line: 1,
          column: 1,
          severity: .note,
        )
  ...
  func `Error on protocol with associated types`() {
    assertMacroExpansionSwiftTesting(
      ...
      diagnostics: [
        DiagnosticSpec(
          message: "@GenerateSpy does not support protocols with associated types",
          line: 1,
          column: 1,
          severity: .error,
        )
  ...
  func `Error on protocol with static members`() {
    assertMacroExpansionSwiftTesting(
      ...
      diagnostics: [
        DiagnosticSpec(
          message: "@GenerateSpy does not support static or class requirements",
          line: 1,
          column: 1,
          severity: .error,
        )
  ...
  func `Renames implementation closure when name collides with protocol property`() {
    assertMacroExpansionSwiftTesting(
      ...
      diagnostics: [
        ...
        DiagnosticSpec(
          message: "@GenerateSpy: 'fetchImplementation' collides with an existing protocol member; using 'fetchImplementationClosure' for the generated implementation closure for 'fetch()'.",
          line: 1,
          column: 1,
          severity: .warning,
        ),
  ...
  func `Renames implementation closure when name collides with protocol method`() {
    assertMacroExpansionSwiftTesting(
      ...
      diagnostics: [
        DiagnosticSpec(
          message: "@GenerateSpy: 'resetImplementation' collides with an existing protocol member; using 'resetImplementationClosure' for the generated implementation closure for 'reset()'.",
          line: 1,
          column: 1,
          severity: .warning,
        )
